    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (updatedPostWithAttendees) {
                ...
                var eventLink = process.env.FRONT_END_URL + `dashboard/${updatedPostWithAttendees.type === 'product' ? 'product' : 'post'}/${updatedPostWithAttendees.slug}?type=${updatedPostWithAttendees.type}`;
